...
<div class="loginbody">
    ...
    <div class="loginbox loginbox1">
        <form action="user" method="post">
            ...
            <ul>
                ...
                <li class="yzm">
                <span><input type="text" name="" value="验证码" onclick="JavaScript:this.value=''"></span><cite>X3D5S</cite>
                </li>
    ...
    <div class="loginbm">版权所有 上海XX信息有限公司 <a href="http://www.xinlang.com">xinlang.com</a>   仅供学习交流，勿用于任何商业用途，交流QQ：690674329</div>
